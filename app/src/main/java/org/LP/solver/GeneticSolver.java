...
public class GeneticSolver {
    ...
    public double GeneticSolver(double[][] students, double[][] houses, int firstGeneration, int numberOfGenerations) {
        GeneticSolver.students = students;
        GeneticSolver.houses = houses;
        GeneticSolver.firstGeneration = firstGeneration;
        GeneticSolver.numberOfGenerations = numberOfGenerations;
        ...
        //Finally sort the solution, costs, distance placesTaken array based on the best solution with the lowest distance violations
